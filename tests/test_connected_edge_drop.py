...
@pytest.mark.parametrize("mixing", (0.001, 0.002, 0.005, 0.01, 0.02, 0.05, 0.1, 0.3))
@pytest.mark.parametrize("p", (0, .1, .25, .5, .75, 1.))
def test_remains_connected(mixing, p):
    ...
    assert num_components(surviving_edges, directed=False) == 1